...
class ProvinciaForm(tk.LabelFrame):
    ...
    def crearCampo(self,field):
        ...
        return entry
    def mostrarEstadoProvinciaEnFormulario(self,provincia,datos):
        values=(provincia.getNombre(),provincia.getCapital(),
                provincia.getHabitantes(),provincia.getDepartamentos(),datos['temp'],
                datos['feels_like'],datos['humidity'])
...
class ProvinciasView(tk.Tk):
    ...
    def verProvinciaEnForm(self,provincia,datos):
        self.form.mostrarEstadoProvinciaEnFormulario(provincia,datos)